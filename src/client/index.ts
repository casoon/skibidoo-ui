...
interface ControllerConstructor {
  new (el: HTMLElement, props: Record<string, unknown>, options?: Record<string, unknown>): ComponentController;
}
...
export class UIHydrator {
   ...
   */
  async hydrate(elOrId: HTMLElement | string): Promise<ComponentController | null> {
